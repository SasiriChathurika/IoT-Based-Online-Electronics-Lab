...
6.  **Run the Flask web application:**  *(Assuming you have a Flask app file, e.g., `app.py`)*
   ...
   #  <img src="project_images/running.jpeg" alt="Running the Server" width="600"/>
   #  <img src="project_images/web-interface.jpeg" alt="Web Interface" width="600"/>
   #  <img src="project_images/output.jpeg" alt="Output Plot" width="600"/>
